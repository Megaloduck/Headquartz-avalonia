...
public class AutomotiveIndustryModule : IIndustryModule
{
    private readonly AutomotiveIndustryContext _ctx;
    public AutomotiveIndustryModule(AutomotiveIndustryContext ctx) => _ctx = ctx;
